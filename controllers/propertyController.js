...
function index(req, res) {
    ...
    i.email_proprietario, i.immagine, i.numero_like, i.id_proprietario, t.tipologia, t.icona, t.id as id_tipologia,
    ...
    i.id_proprietario, t.tipologia, t.icona, t.id;
    ;`;
...
function show(req, res) {
    ...
    i.indirizzo, i.email_proprietario, i.immagine, i.numero_like, i.id_proprietario, t.tipologia, t.icona, t.id as id_tipologia
